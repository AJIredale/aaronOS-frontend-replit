...
export default function SearchOverlay({ isOpen, onClose }: SearchOverlayProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl min-h-[400px] max-h-[600px] h-[500px] p-0 bg-white border border-gray-200 shadow-xl sm:min-h-[500px] sm:h-[580px] flex flex-col" hideCloseButton>
        {/* Search Header */}
        ...
        <div className="flex-1 overflow-hidden flex flex-col min-h-0">
          {/* New Chat Option - Always present but only visible when searching */}
          {searchQuery && (
          ...
          {/* Results Area - Always takes remaining space */}
